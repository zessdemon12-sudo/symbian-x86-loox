...
def create_symbian_menu_icon(path, size=48):
    ...
    # 4 grid squares / circles characteristic of Symbian Belle menu
...
def create_wallpaper(path, width=1024, height=600):
    ...
    # Symbian deep blue abstract curves / waves
    ...
    # Smooth sine waves resembling Symbian Belle waves
...
create_app_icon(os.path.join(APPS_DIR, "sysmanager.png"), "Task Manager", ("#5E35B1", "#4527A0"), "sys")
